...
const contactInfo = [
  {
    icon: Mail,
    label: "Email",
    value: "kumbharomkar747@gmail.com",
    href: "mailto:kumbharomkar747@gmail.com",
  },
  {
    icon: Phone,
    label: "Phone",
    value: "+91-72xxxxxxx5",
    href: "tel:+917249546215", // Masked, so not clickable
  },
  {
    icon: Linkedin,
    label: "LinkedIn",
...
export function Contact() {
  ...
  const onSubmit = async (data: ContactFormData) => {
    ...
    await toast.promise(
      (async () => {
        try {
          const response = await fetch("https://formspree.io/f/mlgwrlaa", {
            method: "POST",
            headers: {
              ...
              <Card className="overflow-hidden">
                <CardContent className="p-0">
                  <div className="relative h-64 bg-muted">
                    <iframe
                      src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d61141.893088749675!2d74.19758252668602!3d16.708464454126226!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bc1000cdec07a29%3A0xece8ea642952e42f!2sKolhapur%2C%20Maharashtra!5e0!3m2!1sen!2sin!4v1754152888646!5m2!1sen!2sin"
                      width="100%"
                      height="100%"
                      style={{ border: 0 }}
                      loading="lazy"
                    ...
                    <div className="absolute bottom-3 left-3 bg-background/90 backdrop-blur-sm px-3 py-2 rounded-lg shadow-lg">
                      <div className="flex items-center gap-2">
                        ...
                        <div>
                          <p className="font-medium text-sm">Kolhapur</p>
