    ...
    >
      ...
      <div className="relative z-10 container mx-auto px-4 text-center">
        ...
        >
          ...
          >
            Omkar <span className="text-primary">Kumbhar</span>
          </motion.h1>
          ...
          >
            ...
            <div className="flex flex-wrap justify-center gap-2">
              ...
              <Badge variant="secondary">Scalable Web Applications</Badge>
            </div>
          </motion.div>
          ...
          >
            ...
            applications. Skilled in modern frameworks and always exploring new
